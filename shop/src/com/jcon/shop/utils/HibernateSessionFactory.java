...
public class HibernateSessionFactory {
	...
	private static final ThreadLocal<Session> threadLocal = new ThreadLocal<Session>();//sessionFactory中使用的是线程池技术
    private static org.hibernate.SessionFactory sessionFactory;//创建session的工厂
